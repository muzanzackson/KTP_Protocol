...
// Define custom data type - int8u (unsigned 8-bit integer)
typedef struct {
    int value; // Internal integer value
} int8u;

int8u init_int8u(int value); // Function to create an int8u value
int8u add_int8u(int8u a, int8u b); // Function to add two int8u values
int8u sub_int8u(int8u a, int8u b); // Function to subtract two int8u values
...
typedef struct {
    ...
    int udp_sockid; // Mapping from KTP socket ID to the corresponding UDP socket ID
...
// Function to get the shared KTP table
ktpSocket *get_shared_KTP_Table(); // Function to get the shared KTP table
